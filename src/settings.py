...
RELEASE_DATE: Optional[str] = "2020-09-21"  # e.g. "YYYY-MM-DD"
...
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://github.com/imesluh/vocalfolds"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = "https://arxiv.org/pdf/1807.06081.pdf"
...
AUTHORS_CONTACTS: Optional[List[str]] = ["laves@imes.uni-hannover.de"]

ORGANIZATION_NAME: Optional[
    Union[str, List[str]]
] = "Institute of Mechatronic Systems, Hannover, Germany"
ORGANIZATION_URL: Optional[Union[str, List[str]]] = "https://microralp.eu/index.html"

# Set '__PRETEXT__' or '__POSTTEXT__' as a key with string value to add custom text. e.g. SLYTAGSPLIT = {'__POSTTEXT__':'some text}
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {
    "__PRETEXT__": "Additionally, each image contains information about its sequence(***seq1***, ***seq2***,***seq3***,***seq4***,***seq5***,***seq6***,***seq7***,***seq8*** tags) and ***patient*** number. Explore it in supervisely labeling tool"
}
